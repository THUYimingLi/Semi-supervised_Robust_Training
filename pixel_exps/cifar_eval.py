...
parser = argparse.ArgumentParser(description='CIFAR-10 Robustness Evaluation')
parser.add_argument('--model-path', default='./checkpoints/CIFAR10/SRT/checkpoint.pth.tar', help='trained model path')
parser.add_argument('--test_batch', type=int, default=200, metavar='N', help='input batch size for testing (default: 200)')
